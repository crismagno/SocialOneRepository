...
export const handleScrollEvent = (event, eventCalled, valueCloser = 10): void => {
    ...
    // console.log("AQUIIIIIIIIIIIIIIIIIIIIIIIIII", scrollIsTop, heightScroll)
    if ((parseInt(scrollIsTop) + valueCloser) >= heightScroll) {
