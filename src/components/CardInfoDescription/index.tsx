      ...
      <View style={styles.containerRight}>
        <View style={styles.containerRightTop}>
          ...
          <If condition={!!props.subtitle}>
            <Animatable.Text animation={"fadeIn"} numberOfLines={1} style={styles.textSubtlitle}>
              {props.subtitle}
            </Animatable.Text>
          </If>
        </View>
        <If condition={!!props.description}>
            <View style={styles.containerBottom}>
                <Animatable.Text animation={"fadeInUp"} style={styles.textDescription}>
                  {props.description}
                </Animatable.Text>
            </View>
        </If>
