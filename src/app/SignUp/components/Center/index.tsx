        ...
        <TextInput
            ...
            left={
                <TextInput.Icon 
                    ...
                    name={"account"} 
                    size={setSize(17)}
                    color={fullNameRef?.current?.isFocused() ? colorsSocial.colorA4 : "#0005"}
                />
            }
        />
        ...
        ref={emailRef}
            ...
            left={
                <TextInput.Icon 
                    ...
                    name={"at"} 
                    size={setSize(17)}
                    color={emailRef?.current?.isFocused() ? colorsSocial.colorA4 :"#0005"}
                />
            }
        />
        ...
        ref={passwordRef}
            ...
            left={
                <TextInput.Icon 
                    ...
                    name={"key"} 
                    size={setSize(17)}
                    color={passwordRef?.current?.isFocused() ? colorsSocial.colorA4 : "#0005"}
                />
            }
            right={
                <TextInput.Icon 
                    ...
                    size={setSize(17)}
                    color={!showPassword && passwordRef.current?.isFocused() ? colorsSocial.colorA4 : "#0005"}
